...
@app.route('/')
def home():
    return '''<h1>Welcome to Place Names API</h1> <a href="https://github.com/Zenomodiff/Places-Names-API" target="blank">Documentation</a>'''


@app.route('/api/Place-Names/all', methods=['GET'])
def api_all():
